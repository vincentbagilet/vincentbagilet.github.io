...
:::: {style="display: flex; align-items: center; justify-content: space-between;"}
::: {.column width="40%"}
[![](images/tools_crop.jpg){width=100% fig-alt="Econometrics = a set of tools for applied economics analyses. Photo by Anton Savinov on Unsplash.com"}](https://vincentbagilet.github.io/metrics_m2/)
:::
...
:::: {style="display: flex; align-items: center; justify-content: space-between;"}
::: {.column width="40%"}
[![](images/paper_graph.jpg){width=100% fig-alt="Photo by Isaac Smith on Unsplash.com"}](https://vincentbagilet.github.io/tada_m2/)
:::

::: {.column width="57%"}
[Data Visualization for Economics Research](https://vincentbagilet.github.io/data_viz_summer/) 

PhD level, Summer School lecture, 2025 and 2026
:::
::::
