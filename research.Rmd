...
A preliminary version of the introduction is available [here](https://vincentbagilet.github.io/causal_exaggeration/causal_exaggeration_intro.pdf).
...
:::: {style="display: flex; align-items: center; justify-content: space-between;"}
::: {.column width="57%"}
### Accurately Estimating Small Effects: Air Pollution and Health
