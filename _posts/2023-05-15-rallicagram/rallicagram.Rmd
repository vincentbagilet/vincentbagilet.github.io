...
For instance, I use `rallicagram` to analyze discourses around the environment in France. It enables to recover the newspaper coverage of a specific term in a few lines one of code. Here, "climatique", in the *Le Monde* newspaper, between 1945 and today:
