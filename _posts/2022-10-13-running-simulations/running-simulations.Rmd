...
description: |
  In this short tutorial I present a simple workflow I use to run econometrics simulations in R.
preview: spiral.jpg
categories:
  - R
  - Simulations
...
This tutorial describes the workflow I use to run fake-data econometrics simulations in R. At the end of the document one can find a template to run a simple simulation from A to Z. It can be copied/pasted and easily adapted to address specific questions. 
