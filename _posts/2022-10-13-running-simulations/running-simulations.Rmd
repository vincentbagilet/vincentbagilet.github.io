...
description: |
  In this short tutorial I present a simple workflow I use to run simulations for regression analysis in R.
preview: spiral.jpg
categories:
  - R
  - Simulations
...
This tutorial describes the workflow I use to run fake-data simulations for regression analysis in R. At the end of the document one can find a template to run a simple simulation from A to Z. It can be copied/pasted and easily adapted to address specific questions. 
...
First load the packages necessary to run the simulation. Here I also load an additional and a non-necessary package to set my default ggplot theme for graphs.
...
mediocrethemes::set_mediocre_all(gradient = "right") #to produce all graphs with my theme
```
